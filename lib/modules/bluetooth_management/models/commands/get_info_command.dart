class GetInfoCommand {
  static List<int> getDeviceInfoCommand() {
    final packet = [0x01, 0x02];
  ...
  static bool validateResponse(List<int> response) {
    if (response.isEmpty || response[0] != 0x01) return false;
  ...
  static bool validateCommand(List<int> commandData) {
    return commandData.length == 3 && commandData[0] == 0x01;
  }
}
